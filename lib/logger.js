    ...
    if (logConsole) {
        if (config.logging.console.colors) {
            if (system === 'daemon' || system === 'childDaemon') {
                ...
                console.log(severityMap[severity](time) + clc.blueBright.bold(' [' + system + '] ' + formattedMessage));
            } else if (formattedMessage.toLowerCase().includes('block') && formattedMessage.toLowerCase().includes('found')){
                console.log(severityMap[severity](time) + clc.magentaBright.bold(' [' + system + '}] ' + formattedMessage));
            }else {
